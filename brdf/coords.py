...
def rangles_to_rvectors(theta_h, theta_d, phi_d):
	# ChatGPT:
	# theta_h: This is the polar angle of the half-vector (h) with respect to the surface normal (n). It ranges from 0 to π/2, with 0 meaning that the half-vector is aligned with the surface normal, and π/2 meaning that the half-vector lies in the tangent plane of the surface.
	# theta_d: This is the polar angle of the view direction (d) with respect to the surface normal (n). It ranges from 0 to π/2, with 0 meaning that the view direction is aligned with the surface normal, and π/2 meaning that the view direction lies in the tangent plane of the surface.
	# phi_d: This is the azimuth angle of the view direction (d) in the tangent plane of the surface, measured with respect to an arbitrary reference direction in the plane. It ranges from 0 to 2π.
